# TODO figure out how to get it to stop vomiting out the entire dataset. also fix the error taht happens when u get this
# might want to just make our own simple dataset class
"""
...
dataset = LeRobotDataset(repo_id, episodes=[0], local_files_only=True)
